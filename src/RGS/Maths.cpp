...
namespace RGS {
    ...
    //平移矩阵详见 https://blog.csdn.net/weixin_46773434/article/details/127417579
    ...
    Mat4 Mat4Scale(float sx, float sy, float sz)
    {
        ...
        m.M[0][0] = sx;
        m.M[1][1] = sy;
        m.M[2][2] = sz;//分别向x,y,z轴方向伸缩sx倍，sy倍，sz倍
        return m;
    }
    //三维空间的旋转矩阵详见 https://www.zhihu.com/tardis/zm/art/96717729?source_id=1005
    ...
    //摄像机矩阵的推导在 https://zhuanlan.zhihu.com/p/552252893
    //m为相机坐标轴与相机位置相乘的结果矩阵LookAt
